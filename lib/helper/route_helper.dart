...
import 'package:efood_multivendor/view/screens/main/main_screen.dart';
...
class RouteHelper {
  ...
  static String getHomeRoute(int id) => '$home?id=$id';
  ...
  static List<GetPage> routes = [
    GetPage(name: initial, page: () => getRoute(MainScreen(pageIndex: 0))),
    GetPage(
        name: splash,
        page: () => SplashScreen(
            orderID:
